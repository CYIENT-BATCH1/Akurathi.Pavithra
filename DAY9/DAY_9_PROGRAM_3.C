...
in a variable “G_Msg_switchstatus_Byte[]” as shown in pic1. Each switch status is
combination of 2 bits as shown in pic2.
...
    switch(num){
    case 1:
        reg0=switch_status|((1<<0)|(1<<1));//register bit 0,and bit 1 will be present
...
        printf("\n");
               for(i=7;i>=0;i--){
                 //print the values in binary form
                printf("%x",n2);
           }
           printf("\n");
        for(i=7;i>=0;i--){
